$(function() {
  ...
  return $("a.create_email_template, button.create_email_template").each(function() {
    var button, container, create_email_template_confirm_button, create_email_template_form, create_email_template_modal;
    button = $(this);
