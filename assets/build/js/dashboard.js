$(function() {
  ...
  $(".dashboard .list_candidats .candidate-box-wrap .buttons.stage-actions button").each(function() {
    return $(this).popup({
      hoverable: true,
      inline: true
    });
  });
  return $(".dashboard .list_candidats .candidate-box-wrap .buttons.stage-actions > button").each(function() {
